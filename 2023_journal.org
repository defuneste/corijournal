...
Project is called *ded* (I guess it *TED*) (see github repo): it take data as input and produce set of graphics in png then they aredropped in google drive for partners
...
- [x] start with {gh}
  following coriverse works out of the box, added comments top help newcomers
  Still some dependencies to install and could take some ime
- [x] git config global :
